    ...
    private void fetchWeatherData(String key, String lat, String lon) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                String description = instance.getString("description");
                String icon = "img" + instance.getString("icon");
                Double temp = main.getDouble("temp");

                result.putExtra("WEATHER", description);
                result.putExtra("SUMMARY", description);
